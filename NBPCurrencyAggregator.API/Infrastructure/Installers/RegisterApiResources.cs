using NBPCurrencyAggregator.API.Constants;
using NBPCurrencyAggregator.API.Contracts;
using NBPCurrencyAggregator.API.Infrastructure.Configs;
using NBPCurrencyAggregator.API.Infrastructure.Handlers;
using NBPCurrencyAggregator.API.Services;
...
namespace NBPCurrencyAggregator.API.Infrastructure.Installers
{
    internal class RegisterApiResources : IServiceRegistration
    {
        public void RegisterAppServices(IServiceCollection services, IConfiguration config)
        {
            ...
            {
                client.BaseAddress = new Uri(config["ApiResourceBaseUrls:NbpApi"]);
