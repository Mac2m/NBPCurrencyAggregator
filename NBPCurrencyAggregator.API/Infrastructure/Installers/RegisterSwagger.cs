...
using NBPCurrencyAggregator.API.Infrastructure.Filters;
...
namespace NBPCurrencyAggregator.API.Infrastructure.Installers
{
    internal class RegisterSwagger : IServiceRegistration
    {
        public void RegisterAppServices(IServiceCollection services, IConfiguration config)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "NBPCurrencyAggregator.API ASP.NET Core API", Version = "v1" });
