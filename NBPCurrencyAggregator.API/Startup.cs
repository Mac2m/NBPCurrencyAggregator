...
using NBPCurrencyAggregator.API.Infrastructure.Extensions;
...
namespace NBPCurrencyAggregator.API
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "NBPCurrencyAggregator.API ASP.NET Core API v1");
            });
